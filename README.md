...
## Продуктовые материалы (из папки «AI оценка 360»)

| Документ | Содержание |
|----------|------------|
| [Концепция 360° оценки сотрудников.txt](docs/product/Концепция%20360°%20оценки%20сотрудников.txt) | Концепция сервиса 360° |
| [business_analysis_360_feedback_service.md](docs/product/business_analysis_360_feedback_service.md) | Бизнес-анализ, use case, требования |
| [task-4.html](docs/product/task-4.html) | Формулировка задания 4 (HTML) |
